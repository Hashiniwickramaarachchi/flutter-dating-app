...
import 'package:datingapp/ambassdor/settingpage.dart/technicalissuesuser.dart';
import 'package:datingapp/homepage.dart';
import 'package:datingapp/settingpage.dart/helpcenter.dart';
...
class f_and_q extends StatefulWidget {
  const f_and_q({super.key});

  @override
  State<f_and_q> createState() => _f_and_qState();
}

class _f_and_qState extends State<f_and_q> {
