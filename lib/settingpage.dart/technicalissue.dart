...
class A_technicalissue extends StatefulWidget {
  String mainname;

  A_technicalissue({required this.mainname, super.key});

  @override
  State<A_technicalissue> createState() => _A_technicalissueState();
}

class _A_technicalissueState extends State<A_technicalissue> {
