...
class interestedit extends StatefulWidget {
  const interestedit({super.key});

  @override
  State<interestedit> createState() => _interesteditState();
}

class _interesteditState extends State<interestedit> {
 ...
 final Set<int> _selectedInterestIcons ={}; // Store icon codePoints as integers
 ...
 final curentuser = FirebaseAuth.instance.currentUser!;
   ...
   style: TextStyle(color: _selectedInterestIndices.contains(_interests[index]['label'])? Colors.white : Colors.black),
   ),
 ...
 return
  ...
  Center(child: Container(
   height: height/50,
   width: width/50,
   child: CircularProgressIndicator(color: Color(0xff7905F5,),)));            }
         }
       ),
    );
