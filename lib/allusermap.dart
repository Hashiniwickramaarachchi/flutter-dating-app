  ...
  Future<void> _getAllUsers() async {
    try {
      ...
      for (var doc in querySnapshot.docs) {
        ...
        Uint8List markerIcon = await _getMarkerWithImage(data['profile_pic'],data['profile']=='premium');
        ...
        _markers.add(
          Marker(
            ...
            infoWindow: InfoWindow(
              title: data['name'],
              snippet:
                  'Age: ${data['Age']}', // Only show age as additional info
            ),
          ),
        );
...
Future<Uint8List> _getMarkerWithImage(String imageUrl,bool check) async {
  try {
    ...
    if (response.statusCode == 200) {
      ...
      const double imageSize = size - (whiteBorderSize * 2); // Inner profile image size
...
if (check==true) {
  ...
  canvas.drawImageRect(
    settingsIcon,
    Rect.fromLTWH(0, 0, settingsIcon.width.toDouble(), settingsIcon.height.toDouble()),
...
Future<ui.Image> loadSettingsIcon() async {
  final ByteData data = await rootBundle.load("assetss/Vector.png",); // Path to settings icon
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (favStatus[user['email']]!) {
                                            ...
                                            FirebaseFirestore.instance
                                                ...
                                                .collection("fav1")
                                                .doc(user['email'])
                                                .delete(); // Delete if it was previously a favorite
                                          }
                                        },
                    ...
                    Padding(
                      padding:
                          EdgeInsets.only(left: 8, right: 8, bottom: 15, top: 30),
                      child: BottomNavBar(
                        selectedIndex2: 1,
                      ),
                    )
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed:() {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(builder:(context) {
                        return ambassdorshow(useremail: widget.useremail);
                      },));
                    
                  }, child: Padding(
                    padding:  EdgeInsets.only(top: 12,bottom: 12),
                    child: Text("Request Ambassador",
