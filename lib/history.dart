  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (histories.isEmpty) return Center(child: Text('No chat history'));
          ...
          itemBuilder: (context, index) {
            ...
            return FutureBuilder<DocumentSnapshot>(
              ...
              builder: (context, userSnapshot) {
                ...
                final chatPartnerProfilePic = userData != null && userData.exists
                        ...
                        child: ListTile(
                          leading: Container(
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: Color(0xff7905F5), width: 2),
                            ),
                            child: Stack(
                              children: [
                                CircleAvatar(
                              ...
                              Text(
                                lastMessage?['timestamp'] != null
                                    ? DateFormat('hh:mm a').format(
                                        (lastMessage!['timestamp'] as Timestamp).toDate().toLocal())
                                    : '',
                                style: TextStyle(
