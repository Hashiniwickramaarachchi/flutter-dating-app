...
width: width,
     ...
     fontSize: height / 50), 
                  ...
                  Padding(
                    padding: EdgeInsets.only(bottom: height / 47, top: height / 10),
                    child: TextField(
   ...
   contentPadding:
       EdgeInsets.only(left: width / 50, top: height / 50),                                 suffixIcon: IconButton(
             onPressed: () {
               setState(() {
             ...
             icon: Icon(
               ...
               size: height / 40,
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: height / 35, bottom: height / 30),
