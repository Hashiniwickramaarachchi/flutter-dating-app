...
class A_filterpage extends StatefulWidget {
  const A_filterpage({super.key});

  @override
  State<A_filterpage> createState() => _A_filterpageState();
}

class _A_filterpageState extends State<A_filterpage> {
                                      ...
                                      label: Text(
                                        ...
                                        style: TextStyle(
                                            color: _selectedInterestIndices
                                                    .contains(_interests[index]
                                                        ['label'])
                                                ? Colors
                                                    .white // White color when selected
                                                : const Color.fromARGB(255, 55,
                                                    55, 55), // Default color
