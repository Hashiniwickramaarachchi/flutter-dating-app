                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Email',
                        contentPadding: EdgeInsets.only(left: width / 50,top: height/90),
                      ),
                    ),
                  ),
                  TextField(
...
try {
 ...
 ScaffoldMessenger.of(context).showSnackBar(SnackBar(
   content: Text("This Email Not Valid in the Ambassdor Account", style: TextStyle(color: Colors.white)),
 ));
