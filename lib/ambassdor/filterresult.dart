...
class A_FilterResult extends StatefulWidget {
  ...
  @override
  _A_FilterResultState createState() => _A_FilterResultState();
}

class _A_FilterResultState extends State<A_FilterResult> {
