...
import 'package:datingapp/ambassdor/profilepicadding.dart';
...
class A_imageadding extends StatefulWidget {
  String email;
  A_imageadding({required this.email, super.key});

  @override
  State<A_imageadding> createState() => _A_imageaddingState();
}

class _A_imageaddingState extends State<A_imageadding> {
  ...
  Future<void> _uploadImagesToFirebase() async {
    ...
    for (int i = 0; i < images.length; i++) {
      if (images[i] != null) {
        String fileName = 'users/${widget.email}/image$i.jpg';
        try {
    ...
    FirebaseFirestore.instance
      ...
      Navigator.of(context).push(MaterialPageRoute(
        builder: (context) {
          return profilepicadding(email: widget.email,);
        },
      ));
    }).catchError((error) {
