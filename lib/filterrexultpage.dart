            ...
            _markers.add(
              Marker(
                ...
                infoWindow: InfoWindow(
                  title: data['name'],
                  snippet: 'Age: ${data['Age']}, Distance: ${userDistance.toInt()} km',
                ),
              ),
            );
          }
            ...
            Column(
              ...
              children: [
               ...
               useremail: widget.useremail);
                               ...
                               decoration: BoxDecoration(
                                ...
                                child: IconButton(
                                  ...
                                  onPressed:() async{
                                                 ...
                                                 setState(() {
                                                favStatus[user['email']] = !favStatus[user['email']]!;
                                                 });
                           ...
                           FirebaseFirestore.instance
                             ...
                             if (documentSnapshot.exists) {
                               ...
                               try {
                                 ...
                                 DocumentReference favDocRef = await FirebaseFirestore
                                     .instance
                                     .collection('Favourite')
                                     .doc(
                                         widget.useremail); // Add the data to the main document in Favourite
                                 print(
                                     "Favourite document created with ID: ${favDocRef.id}");
                                 // Step 3: Create a subcollection under the newly created document
                                 await favDocRef
                                     .collection("fav1") // Subcollection name
                                     .doc(user['email']) // Use the same ID as in the "Sell" collection
                                     .set(
                                 ...
                                 FirebaseFirestore.instance
                                     ...
                                     .collection("fav1")
                                     .doc(user['email']) // Replace with the document ID you want to update
                                     .update({'fav1': true})
                                     .then(
                                         (_) => print("Favorite updated to true"))
                               ...
                               print("Document does not exist in Sell collection");
                             }
                           }).catchError((error) {
                             print(
                         ...
                         Padding(
           padding:  EdgeInsets.only(left: 8,right: 8,bottom: 15,top: 30),
           child: BottomNavBar(
             selectedIndex2: 1,
           ),
         )
